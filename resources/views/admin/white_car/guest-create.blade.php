...
@section('content')
    ...
    <div id="admin_wcl" class="card card-primary">
        ...
        <form action="{{ route('admin.white-cars.guest.store') }}" method="POST" role="form">
            @csrf
            <div class="card-body">
            ...
            <div class="card-footer">
                ...
                <a style="margin-left: 20px;" href="{{ route('admin.white-cars.guest.index') }}" class="btn btn-warning">Отменить</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
